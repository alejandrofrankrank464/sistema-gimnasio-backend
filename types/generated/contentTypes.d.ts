...
export interface ApiClienteCliente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Zumba: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
  };
}
...
export interface ApiConfiguracionConfiguracion
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valor: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
export interface ApiLogLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Entidad: Schema.Attribute.String & Schema.Attribute.Required;
    EntidadId: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPagoPago extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AnioPago: Schema.Attribute.Integer & Schema.Attribute.Required;
    cliente: Schema.Attribute.Relation<'manyToOne', 'api::cliente.cliente'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FechaPago: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pago.pago'> &
      Schema.Attribute.Private;
    MesPago: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    Monto: Schema.Attribute.Decimal &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    TipoServicio: Schema.Attribute.Enumeration<
      ['Normal', 'VIP', 'Zumba', 'Box', 'Zumba y Box', 'VIP + Zumba y Box']
    > &
      Schema.Attribute.Required &
